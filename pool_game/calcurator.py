...
root.title('simple calcurator in 2022')
...
button_minus = Button(root, text='-',padx=20, pady=10)
button_minus.grid(row=5, column=1)
button_multiply = Button(root, text='*',padx=20, pady=15)
button_multiply.grid(row=3, column=3)
button_divide = Button(root, text='/',padx=20, pady=15)
